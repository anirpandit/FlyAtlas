...
$ua = $ENV{REMOTE_ADDR};
	$annot_file="Drosophila_2.na26.annot.csv";
	$array_file="all.txt";
	$maxhits=100;
...
#***places to add code for new tissues are marked like this***
@tissuenames= ("brain","head","crop","midgut","hindgut","tubule","ovary","testis","male accessory gland","larval tubule","larval fat body","thoracicoabdominal ganglion","adult carcass","salivary gland","larval salivary gland","larval midgut","larval hindgut","virgin spermatheca","mated spermatheca","whole fly");
...
#***places to add code for new tissues are marked like this***
 " Which tissue interests you? ",popup_menu(-name=>'tissue',
	       -values=>['brain','head','crop','midgut','tubule','hindgut','ovary','testis','male accessory gland','larval tubule','larval fat body','thoracicoabdominal ganglion','adult carcass','salivary gland','larval salivary gland','larval midgut','larval hindgut','virgin spermatheca','mated spermatheca','whole fly']);
...
#       print "$cg",br;
 ...
 #look for matching Vienna data 
      ...
      printf ("<tr><td>Larval fat body</td><td>%d \xb1 %d</td><td>%d of 4</td><td>%5.2f</td><td>$l_fat_fly_t</td></tr>",$l_fatMean,$l_fatSEM,$l_fatCall,$l_fatRatio);#***places to add code for new tissues are marked like this***
