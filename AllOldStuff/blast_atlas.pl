...
print  "<td><h1>BLASTP the Drosophila adult expression atlas</h1></td>";
...
print " <td><div align=\"center\"><font color=\"#0033FF\" size=\"1\"><a href=\"meta/equation.html\">Interesting meta-analysis</a></font></div></td>";
...
print "This search takes you directly from protein sequence (any species) to closely matching (1e$critlevel) Drosophila genes with their expression data - in 10 seconds!",br;
}
