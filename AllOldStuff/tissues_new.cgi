...
#***places to add code for new tissues are marked like this***
@tissuenames= ("brain","head","crop","midgut","hindgut","tubule","ovary","testis","male accessory gland","larval tubule","larval fat body","thoracicoabdominal ganglion","adult carcass","whole fly");
...
#***places to add code for new tissues are marked like this***
 " Which tissue interests you? ",popup_menu(-name=>'tissue',
	       -values=>['brain','head','crop','midgut','tubule','hindgut','ovary','testis','male accessory gland','larval tubule','larval fat body','thoracicoabdominal ganglion','adult carcass','whole fly']);
